...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post websites_url, params: { website: { email: @website.email, weburl: @website.weburl } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { email: @website.email, weburl: @website.weburl } }
